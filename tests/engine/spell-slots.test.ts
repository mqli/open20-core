...
const SPELLCASTING_CLASSES: Record<string, Class> = {
  Wizard: { id: 'Wizard', name: 'Wizard', source: '2024 PHB', hitDie: 'd6', savingThrowProficiencies: ['Intelligence', 'Wisdom'], armorTraining: [], weaponMastery: false, featuresByLevel: [], spellcasting: { ability: 'Intelligence', prepares: true } },
  Cleric: { id: 'Cleric', name: 'Cleric', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Wisdom', 'Charisma'], armorTraining: ['Light', 'Medium', 'Shield'], weaponMastery: false, featuresByLevel: [], spellcasting: { ability: 'Wisdom', prepares: true } },
  Bard: { id: 'Bard', name: 'Bard', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Dexterity', 'Charisma'], armorTraining: ['Light'], weaponMastery: false, featuresByLevel: [], spellcasting: { ability: 'Charisma', prepares: false } },
  Sorcerer: { id: 'Sorcerer', name: 'Sorcerer', source: '2024 PHB', hitDie: 'd6', savingThrowProficiencies: ['Constitution', 'Charisma'], armorTraining: [], weaponMastery: false, featuresByLevel: [], spellcasting: { ability: 'Charisma', prepares: false } },
  Druid: { id: 'Druid', name: 'Druid', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Intelligence', 'Wisdom'], armorTraining: ['Light', 'Medium', 'Shield'], weaponMastery: false, featuresByLevel: [], spellcasting: { ability: 'Wisdom', prepares: true } },
  Paladin: { id: 'Paladin', name: 'Paladin', source: '2024 PHB', hitDie: 'd10', savingThrowProficiencies: ['Wisdom', 'Charisma'], armorTraining: ['Light', 'Medium', 'Heavy', 'Shield'], weaponMastery: true, featuresByLevel: [], spellcasting: { ability: 'Charisma', prepares: true } },
  Ranger: { id: 'Ranger', name: 'Ranger', source: '2024 PHB', hitDie: 'd10', savingThrowProficiencies: ['Strength', 'Dexterity'], armorTraining: ['Light', 'Medium', 'Shield'], weaponMastery: true, featuresByLevel: [], spellcasting: { ability: 'Wisdom', prepares: true } },
  Warlock: { id: 'Warlock', name: 'Warlock', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Wisdom', 'Charisma'], armorTraining: ['Light'], weaponMastery: false, featuresByLevel: [], spellcasting: { ability: 'Charisma', prepares: false } },
