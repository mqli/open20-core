...
const SPELLCASTING_CLASSES: Record<string, Class> = {
  Wizard: { id: 'Wizard', name: 'Wizard', source: '2024 PHB', hitDie: 'd6', savingThrowProficiencies: ['Intelligence', 'Wisdom'], armorTraining: [], weaponMastery: false, featuresByLevel: [], spellcasting: { type: 'preparation', ability: 'Intelligence', knownSource: 'spellbook', changesPerRest: 'all' } },
  Cleric: { id: 'Cleric', name: 'Cleric', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Wisdom', 'Charisma'], armorTraining: ['Light', 'Medium', 'Shield'], weaponMastery: false, featuresByLevel: [], spellcasting: { type: 'preparation', ability: 'Wisdom', knownSource: 'class_list', changesPerRest: 'all' } },
  Bard: { id: 'Bard', name: 'Bard', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Dexterity', 'Charisma'], armorTraining: ['Light'], weaponMastery: false, featuresByLevel: [], spellcasting: { type: 'known', ability: 'Charisma', changesPerLevel: 1 } },
  Sorcerer: { id: 'Sorcerer', name: 'Sorcerer', source: '2024 PHB', hitDie: 'd6', savingThrowProficiencies: ['Constitution', 'Charisma'], armorTraining: [], weaponMastery: false, featuresByLevel: [], spellcasting: { type: 'known', ability: 'Charisma', changesPerLevel: 1 } },
  Druid: { id: 'Druid', name: 'Druid', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Intelligence', 'Wisdom'], armorTraining: ['Light', 'Medium', 'Shield'], weaponMastery: false, featuresByLevel: [], spellcasting: { type: 'preparation', ability: 'Wisdom', knownSource: 'class_list', changesPerRest: 'all' } },
  Paladin: { id: 'Paladin', name: 'Paladin', source: '2024 PHB', hitDie: 'd10', savingThrowProficiencies: ['Wisdom', 'Charisma'], armorTraining: ['Light', 'Medium', 'Heavy', 'Shield'], weaponMastery: true, featuresByLevel: [], spellcasting: { type: 'preparation', ability: 'Charisma', knownSource: 'class_list', changesPerRest: 1 } },
  Ranger: { id: 'Ranger', name: 'Ranger', source: '2024 PHB', hitDie: 'd10', savingThrowProficiencies: ['Strength', 'Dexterity'], armorTraining: ['Light', 'Medium', 'Shield'], weaponMastery: true, featuresByLevel: [], spellcasting: { type: 'preparation', ability: 'Wisdom', knownSource: 'class_list', changesPerRest: 1 } },
  Warlock: { id: 'Warlock', name: 'Warlock', source: '2024 PHB', hitDie: 'd8', savingThrowProficiencies: ['Wisdom', 'Charisma'], armorTraining: ['Light'], weaponMastery: false, featuresByLevel: [], spellcasting: { type: 'known', ability: 'Charisma', changesPerLevel: 1, pactMagic: true } },
