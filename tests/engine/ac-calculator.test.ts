...
const defaultScores: AbilityScores = {
  base: { Strength: 15, Dexterity: 14, Constitution: 14, Intelligence: 10, Wisdom: 13, Charisma: 8 },
  racialBonuses: {},
  featBonuses: {},
  temporaryBonuses: {},
};
...
const LEATHER_ARMOR: Armor = {
  id: 'Leather Armor', type: 'armor', category: 'Light', baseAC: 11,
  dexBonus: true, equipped: true, weight: 10, cost: '10 gp',
};

const CHAIN_MAIL: Armor = {
  id: 'Chain Mail', type: 'armor', category: 'Heavy', baseAC: 16,
  dexBonus: false, strengthRequirement: 13, stealthDisadvantage: true,
  equipped: true, weight: 55, cost: '75 gp',
};

const HALF_PLATE: Armor = {
  id: 'Half Plate', type: 'armor', category: 'Medium', baseAC: 15,
  dexBonus: true, dexCap: 2, stealthDisadvantage: true,
  equipped: true, weight: 40, cost: '750 gp',
};

const SHIELD: Armor = {
  id: 'Shield', type: 'armor', category: 'Shield', baseAC: 2,
  dexBonus: false, equipped: true, weight: 6, cost: '10 gp',
};
...
describe('calculateAC', () => {
  ...
  it('light armor = armor AC + Dex', () => {
    const equip: EquipmentItem[] = [{ id: 'Leather Armor', name: 'Leather Armor', type: 'armor', weight: 10, cost: '10 gp', equipped: true }];
  ...
  it('heavy armor = armor AC only (no Dex)', () => {
    const equip: EquipmentItem[] = [{ id: 'Chain Mail', name: 'Chain Mail', type: 'armor', weight: 55, cost: '75 gp', equipped: true }];
  ...
  it('medium armor = armor AC + min(Dex, +2)', () => {
    const equip: EquipmentItem[] = [{ id: 'Half Plate', name: 'Half Plate', type: 'armor', weight: 40, cost: '750 gp', equipped: true }];
  ...
  it('shield adds +2 to any armor', () => {
    const equip: EquipmentItem[] = [
      { id: 'Chain Mail', name: 'Chain Mail', type: 'armor', weight: 55, cost: '75 gp', equipped: true },
  ...
  it('unequipped armor does not count', () => {
    const equip: EquipmentItem[] = [{ id: 'Chain Mail', name: 'Chain Mail', type: 'armor', weight: 55, cost: '75 gp', equipped: false }];
    const data = createMockDataLoader({ 'Chain Mail': CHAIN_MAIL });
